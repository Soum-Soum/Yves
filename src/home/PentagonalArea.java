...
public class PentagonalArea extends Area implements Serializable {
    ...
    public void setOutLines() {
        ...
        outlinesMontants.put("topLeftMontant",Montant.getParalelMontant(shap.topLeft,DATACONTAINER.MONTANTWIDTH,true,ShapeType.PARALLELOGRAM1));
        outlinesMontants.put("topRightMontant",Montant.getParalelMontant(shap.topRight,DATACONTAINER.MONTANTWIDTH,true,ShapeType.PARALLELOGRAM1));
        ...
        outlinesMontants.put("leftMontant",Montant.getNormalMontant(leftSeg,DATACONTAINER.MONTANTWIDTH,true,ShapeType.TRAPEZIUM1,shap.thetaLeft,0));
        outlinesMontants.put("rightMontant",Montant.getNormalMontant(rightSeg,DATACONTAINER.MONTANTWIDTH,false,ShapeType.TRAPEZIUM2,shap.thetaRight,0));
